#' 1pl LSIRM model with model selection approach for missing completely at random data. 
#' @description \link{lsirm1pl_mcar_ss} is used to fit LSIRM model with model selection approach based on spike-and-slab priors in incomplete data assumed to be missing completely at random. 
...
lsirm1pl_mcar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
                           ...
                           pr_a_theta = 0.001, pr_b_theta = 0.001, pr_xi_a  = 1, pr_xi_b = 1,  missing = 99){
  
  output <- lsirm1pl_mcar_ss_cpp(data=data, ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
                             ...
                             pr_a_theta=pr_a_theta, pr_b_theta=pr_b_theta, pr_beta_a=pr_xi_a, pr_beta_b=pr_xi_b, missing=missing)
