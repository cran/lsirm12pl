#' 1pl LSIRM model with normal likelihood using multiplicative effect for missing completely at random data. 
#' 
#' @description \link{intrm1pl_normal_mcar} is used to fit LSIRM model for continuous variable with 1pl using multiplicative effect in incomplete data under missing completely at random assumption.
#' 
...
#' 
#' @return \code{intrm1pl_normal_mcar} returns an object of  list containing the following components:
...
#' 
#' @export
intrm1pl_normal_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <-  intrm1pl_normal_mcar_cpp(data, niter, nburn, nthin, nprint,
