#' 2pl LSIRM model fixing gamma to 1 for missing at random data. 
#' 
#' @description \link{lsirm2pl_fixed_gamma_mar} is used to fit 2pl LSIRM model fixing gamma to 1 in incomplete data assumed to be missing at random. 
...
#' lsirm_result <- lsirm2pl(data, spikenslab = FALSE, fixed_gamma = TRUE, missing_data = "mar")
#' }
#' 
#' @export
lsirm2pl_fixed_gamma_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_fixed_gamma_mar_cpp(data, ndim, niter, nburn, nthin, nprint,
