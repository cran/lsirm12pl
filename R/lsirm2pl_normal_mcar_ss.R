#' 2pl LSIRM model with normal likelihood and model selection approach for missing completely at random data. 
#' 
#' @description \link{lsirm2pl_normal_mcar_ss} is used to fit 2pl LSIRM model with model selection approach based on spike-and-slab priors for continuous variable in incomplete data assumed to be missing completely at random. 
...
#' lsirm_result <- lsirm2pl_normal(data, spikenslab = TRUE, fixed_gamma = FALSE,
#'                                 missing_data = "mcar")
#' 
#' @export
lsirm2pl_normal_mcar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_mcar_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
