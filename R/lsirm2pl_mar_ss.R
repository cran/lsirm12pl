...
#' 
#' @description \link{lsirm2pl_mar_ss} is used to fit 2pl LSIRM model based on spike-and-slab priors in incomplete data assumed to be missing at random. 
...
#' lsirm_result <- lsirm2pl(data, spikenslab = TRUE, fixed_gamma = FALSE, missing_data = "mar")
#' }
#' 
#' @export
lsirm2pl_mar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_mar_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
