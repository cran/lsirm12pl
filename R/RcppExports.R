...
intrm1pl_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta) {
    .Call('_lsirm12pl_intrm1pl_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta)
}

intrm1pl_mar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm1pl_mar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta, missing)
}

intrm1pl_mcar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm1pl_mcar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_theta, pr_b_theta, missing)
}

intrm1pl_normal_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta) {
    .Call('_lsirm12pl_intrm1pl_normal_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta)
}

intrm1pl_normal_mar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm1pl_normal_mar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, missing)
}

intrm1pl_normal_mcar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm1pl_normal_mcar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, missing)
}

intrm2pl_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta) {
    .Call('_lsirm12pl_intrm2pl_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta)
}

intrm2pl_mar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm2pl_mar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta, missing)
}

intrm2pl_mcar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta, missing) {
    .Call('_lsirm12pl_intrm2pl_mcar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, pr_a_theta, pr_b_theta, missing)
}

intrm2pl_normal_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha) {
    .Call('_lsirm12pl_intrm2pl_normal_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha)
}

intrm2pl_normal_mar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, missing) {
    .Call('_lsirm12pl_intrm2pl_normal_mar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, missing)
}

intrm2pl_normal_mcar_cpp <- function(data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, missing) {
    .Call('_lsirm12pl_intrm2pl_normal_mcar_cpp', PACKAGE = 'lsirm12pl', data, niter, nburn, nthin, nprint, jump_beta, jump_theta, jump_alpha, jump_delta, pr_mean_beta, pr_sd_beta, pr_mean_theta, pr_a_eps, pr_b_eps, pr_a_theta, pr_b_theta, pr_mean_delta, pr_sd_delta, pr_mean_alpha, pr_sd_alpha, missing)
}
