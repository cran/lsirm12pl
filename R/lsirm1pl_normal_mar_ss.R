...
#' 
#' @description \link{lsirm1pl_normal_mar_ss} is used to fit LSIRM model with model selection approach based on spike-and-slab priors for continuous variable with 1pl in incomplete data assumed to be missing at random.
...
#' 
#' @return \code{lsirm1pl_normal_mar_ss} returns an object of  list containing the following components:
...
#' lsirm_result <- lsirm1pl_normal(data, spikenslab = TRUE, fixed_gamma = FALSE,
#'                                 missing_data = 'mar')
#' 
#' @export
lsirm1pl_normal_mar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
                                   ...
                                   pr_xi_a = 0.001, pr_xi_b = 0.001, missing = 99){
  
  output <- lsirm1pl_normal_mar_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
