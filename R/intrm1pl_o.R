#' 1pl LSIRM model using multiplicative effect
#' 
#' @description \link{intrm1pl_o} is used to fit 1pl LSIRM model using multiplicative effect. 
...
#' 
#' 
#' @return \code{intrm1pl_o} returns an object of  list containing the following components:
...
#' 
#' @export
intrm1pl_o = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- intrm1pl_cpp(data=data, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint, 
