...
#' lsirm_result <- lsirm1pl(data, spikenslab = TRUE, fixed_gamma = FALSE)
#' }
#'  
#' @export
lsirm1pl_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm1pl_ss_cpp(data=data, ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
