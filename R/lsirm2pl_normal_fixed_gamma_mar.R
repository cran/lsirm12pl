#' 2pl LSIRM model fixing gamma to 1 with normal likelihood for missing at random data. 
#' 
#' @description \link{lsirm2pl_normal_fixed_gamma_mar} is used to fit 2pl LSIRM model with gamma fixed to 1 for continuous variable in incomplete data assumed to be missing at random. 
#' 
...
lsirm2pl_normal_fixed_gamma_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_fixed_gamma_mar_cpp(data, 
