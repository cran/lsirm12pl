...
#'
#' lsirm_result <- lsirm1pl_normal_mcar(data, niter = 1000, nburn = 500)
#'
...
lsirm1pl_normal_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
                                ...
                                pr_a_theta = 0.001, pr_b_theta = 0.001, pr_a_eps = 0.001, pr_b_eps = 0.001, missing.val = NA, verbose=FALSE, fix_theta_sd=FALSE, adapt = NULL) {
  if(niter <= nburn){
