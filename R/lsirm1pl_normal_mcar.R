#' 1pl LSIRM model with normal likelihood for missing completely at random data. 
#' 
#' 
#' @description \link{lsirm1pl_normal_mcar} is used to fit LSIRM model with 1pl in incomplete data assumed to be missing completely at random.
...
lsirm1pl_normal_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm1pl_normal_mcar_cpp(data, ndim, niter, nburn, nthin, nprint,
