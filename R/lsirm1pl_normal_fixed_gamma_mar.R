#' 1pl LSIRM model fixing gamma to 1 with normal likelihood for missing at random data. 
#' 
#' 
#' @description \link{lsirm1pl_normal_fixed_gamma_mar} is used to fit 1pl LSIRM model for continuous variable with gamma fixed to 1 in incomplete data assumed to be missing at random.
#' 
...
lsirm1pl_normal_fixed_gamma_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
                                            ...
                                            pr_a_eps = 0.001, pr_b_eps = 0.001, missing = 99){
  
  output <- lsirm1pl_normal_fixed_gamma_mar_cpp(data,  ndim,  niter,  nburn,  nthin,  nprint,
