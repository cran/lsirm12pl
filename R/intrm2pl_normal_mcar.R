#' LSIRM model with normal likelihood and 2pl using multiplicative effect for missing completely at random data. 
#' 
#' @description \link{intrm2pl_normal_mar} is used to fit 2pl LSIRM model for continuous variable using multiplicative effect in incomplete data under missing completely at random assumption.
...
#' 
#' @return \code{intrm2pl_normal_mcar} returns an object of  list containing the following components:
...
#' 
#' lsirm_result <- intrm2pl_normal_mcar(data)
#' 
#' # The code following can achieve the same result.
#' lsirm_result <- intrm2pl_normal(data, missing_data = 'mcar')
#' 
#' @export
intrm2pl_normal_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- intrm2pl_normal_mcar_cpp(data, niter, nburn, nthin, nprint,
