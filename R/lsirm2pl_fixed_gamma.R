#' 2pl LSIRM model fixing gamma to 1.
#' 
#' @description \link{lsirm2pl_fixed_gamma} is used to fit 2pl LSIRM model fixing gamma to 1. 
...
#' lsirm_result <- lsirm2pl(data, spikenslab = FALSE, fixed_gamma = TRUE)
#' }
#' 
#' @export
lsirm2pl_fixed_gamma = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_fixed_gamma_cpp(data, ndim, niter, nburn, nthin, nprint,
