#' 1pl LSIRM model with model selection approach for missing at random data. 
#' @description \link{lsirm1pl_mar_ss} is used to fit 1pl LSIRM model with model selection approach based on spike-and-slab priors in incomplete data assumed to be missing at random. 
...
#' lsirm_result <- lsirm1pl(data, spikenslab = TRUE, fixed_gamma = FALSE, missing_data = 'mar')
#' }
#' 
#' @export
lsirm1pl_mar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm1pl_mar_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
                            ...
                            pr_a_theta, pr_b_theta, pr_beta_a = pr_xi_a, pr_beta_b = pr_xi_b, missing)
