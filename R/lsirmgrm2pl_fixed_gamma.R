#' 2PL GRM LSIRM fixing gamma to 1.
#'
#' @description \link{lsirmgrm2pl_fixed_gamma} is used to fit 2PL GRM LSIRM with gamma fixed to 1.
#'
...
#' }
#' 
#' @return \code{lsirmgrm2pl_fixed_gamma} returns an object of  list containing the same components as \code{\link{lsirmgrm2pl}}.
#'
#' @export
lsirmgrm2pl_fixed_gamma <- function(data, ncat = NULL, missing_data = NA, missing.val = 99,
