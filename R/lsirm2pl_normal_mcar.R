#' 2pl LSIRM model with normal likelihood and missing completely at random data. 
#' 
#' @description \link{lsirm2pl_normal_mcar} is used to fit 2pl LSIRM model for continuous variable in incomplete data assumed to be missing completely at random. 
...
#' lsirm_result <- lsirm2pl_normal(data, spikenslab = FALSE, fixed_gamma = FALSE,
#'                                 missing_data = "mcar")
#' 
#' @export
lsirm2pl_normal_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_mcar_cpp(data, 
