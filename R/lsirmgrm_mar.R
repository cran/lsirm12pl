#' 1PL GRM LSIRM for missing at random data.
#'
#' @description \link{lsirmgrm_mar} is used to fit 1PL GRM LSIRM in incomplete data assumed to be missing at random.
#'
...
#' 
#' @export
lsirmgrm_mar <- function(data, ncat = NULL, missing.val = 99,
  ...
  lsirmgrm(data = data, ncat = ncat, missing_data = "mar", missing.val = missing.val,
