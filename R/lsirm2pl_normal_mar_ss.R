#' 2pl LSIRM model with normal likelihood and model selection approach for missing at random data. 
#' 
#' @description \link{lsirm2pl_normal_mar_ss} is used to fit 2pl LSIRM model with model selection approach based on spike-and-slab priors for continuous variable in incomplete data assumed to be missing at random. 
...
lsirm2pl_normal_mar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_mar_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
