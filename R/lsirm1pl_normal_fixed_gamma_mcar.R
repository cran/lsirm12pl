...
#'
#' lsirm_result <- lsirm1pl_normal_fixed_gamma_mcar(data, niter = 1000, nburn = 500)
#'
#' # The code following can achieve the same result.
#' lsirm_result <- lsirm(data ~ lsirm1pl(spikenslab = FALSE, fixed_gamma = TRUE,
#'                       niter = 1000, nburn = 500,
#' missing_data = "mcar", missing.val = NA))
#'
#' @export
lsirm1pl_normal_fixed_gamma_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
