#' 1pl LSIRM model fixing gamma to 1 with normal likelihood for missing completely at random data. 
#' 
#' 
#' @description \link{lsirm1pl_normal_fixed_gamma_mcar} is used to fit 1pl LSIRM model for continuous variable with gamma fixed to 1 in incomplete data assumed to be missing completely at random.
#' 
...
lsirm1pl_normal_fixed_gamma_mcar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm1pl_normal_fixed_gamma_mcar_cpp(data,  ndim,  niter,  nburn,  nthin,  nprint,
