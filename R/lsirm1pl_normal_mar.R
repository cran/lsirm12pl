#' 1pl LSIRM model with normal likelihood for missing at random data. 
#' 
#' @description \link{lsirm1pl_normal_mar} is used to fit LSIRM model for continuous variable with 1pl in incomplete data assumed to be missing at random.
...
#' lsirm_result <- lsirm1pl_normal(data, spikenslab = FALSE, fixed_gamma = FALSE,
#'                                 missing_data = 'mar')
#' 
#' 
#' @export
lsirm1pl_normal_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm1pl_normal_mar_cpp(data, ndim, niter, nburn, nthin, nprint,
