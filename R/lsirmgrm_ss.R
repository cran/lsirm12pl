#' 1PL GRM LSIRM with spike-and-slab prior.
#'
#' @description \link{lsirmgrm_ss} is used to fit 1PL GRM LSIRM with spike-and-slab prior.
#'
...
#' 
#' @export
lsirmgrm_ss <- function(data, ncat = NULL, missing_data = NA, missing.val = 99,
