#' 2pl LSIRM model with normal likelihood and missing at random data. 
#' 
#' @description \link{lsirm2pl_normal_mar} is used to fit 2pl LSIRM model for continuous variable in incomplete data assumed to be missing at random. 
...
lsirm2pl_normal_mar = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_mar_cpp(data, 
