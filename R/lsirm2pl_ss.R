#' 2pl LSIRM model with model selection approach. 
#' 
#' @description \link{lsirm2pl_ss} is used to fit 2pl LSIRM model with model selection approach based on spike-and-slab priors. 
...
#'  lsirm_result <- lsirm2pl(data, spikenslab = TRUE, fixed_gamma = FALSE)
#' }
#'  
#' @export
lsirm2pl_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_ss_cpp(data, ndim, niter, nburn, nthin, nprint,
