...
lsirm2pl_normal_fixed_gamma = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
  ...
  output <- lsirm2pl_normal_fixed_gamma_cpp(data=as.matrix(data), ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
                                            ...
                                            pr_a_eps=pr_a_eps,  pr_b_eps=pr_b_eps, pr_mean_alpha=pr_mean_alpha, pr_sd_alpha=pr_sd_alpha, verbose=verbose, fix_theta_sd=fix_theta_sd, fix_alpha_1=fix_alpha_1, adapt=adapt)
